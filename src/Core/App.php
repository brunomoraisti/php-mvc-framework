...
class App
{
    ...
    public function __construct()
    {
        ...
        if (!empty($response)) {
            ...
            $message .= "<b>Informações adicionais:</b>  " . $e->getMessage() . "<br/>" . $e->getCode() . "<br/>" . $e->getPrevious() . "<br/></p>";
            ...
            if (CONFIG_DATA_LAYER["display_errors_details"]) {
                ...
                EmailClass::sendEmail("Erro no servidor | ".(new FuncoesClass())->pegarDataHoraAtualUsuario(), $message, array(CONFIG_DEVELOPER['email']));
